...
- [JDart] - Dynamic symbolic execution tool built on Java PathFinder. Supports multiple constraint solvers using JConstraints.CATG 
...
- [S2E](https://s2e.systems/) - Symbolic execution platform supporting x86, x86-64, or ARM software stacks.
...
- **[angr](https://github.com/angr/angr)** - Python framework for analyzing binaries. Includes a symbolic execution tool.
...
![image-20210120213711576](img/image-20210120213711576.png)

### (2).S2E(binary code)

> complex but very powerful full stack analysis

![image-20210120213859973](img/image-20210120213859973.png)
...
![image-20210120214016856](img/image-20210120214016856.png)
